...
const Clients = () => {
    ...
    return (
        <div className=" Clients  ">
            ...
            <div>
            <div>
            <p className=" BestText ">What our clients say</p>               
            </div>
            <div className=" all-client-card">
            <div className=" Client-cardOne ">
            <img className=" img-border " height="310px" width="220px" src="https://s3-alpha-sig.figma.com/img/a15b/c589/63ffb301f03a98268a3c0ab584d30a79?Expires=1733097600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=bU~M592OjHbAQl1p0Tl4RbOUNGdvVLW28rH3DeHaBUlTXqLQ-HlsC~SJyRDk285pIAXvm-p7MuMP6hRLGpkZaRxu6hAnvw-C81QaXAhEcIEyuXKLRpVFd80Ed7UE6ckzBZtYGZLFkyWsN2wh3AYhn1leXgLZFqWhVq5Y-3KY2DFgE5z9j~WCNU2OCSYXt1ZKkapu4R11sEBThKmnCctNjjaKzZ42SHScndF6XGkiCLYr2fqKc~LaU2pDmA1bkqXISrp~C4bdHa3VaBH9rR8hMEd8o5cVljaOl6CADY2BEdl87cJZeDqNcA5JOF9ktZvN9KBUhqsLGEH3z9TQw3Sp4A__"
            alt="" />
            <div className=" C-R ">
            ...
            <p className=" CT-2 ">Roy Rakabuming</p>
            </div>
            </div>
            <div className=" Client-cardOne ">
            ...
            <p className=" CT-1 ">As expected, 10 years experience on<br></br> furniture business will not<br></br> disappointing at all</p>
            <p className=" CT-2 ">As they said, their 10 years of experience in<br></br>furniture and interior business is real. They<br></br> work it professionally and friendly at the same<br></br> time and of course the results is beyond my<br></br> expectations.</p>
            <p className=" CT-2 ">Dafit Bekam</p>
            </div>
            </div>
            </div>
            </div>
